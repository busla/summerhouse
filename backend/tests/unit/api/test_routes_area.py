...
Tests for:
- GET /api/area - Local area information
- GET /api/area/recommendations - Personalized recommendations
"""
...
class TestGetAreaInfo:
    """Tests for GET /api/area endpoint."""
    ...
    def test_filter_by_beach_category(self, client: TestClient) -> None:
        ...
        response = client.get("/api/area?category=beach")
        assert response.status_code == HTTP_200_OK
...
class TestGetRecommendations:
    """Tests for GET /api/area/recommendations endpoint."""
    ...
    def test_custom_limit(self, client: TestClient) -> None:
        ...
        response = client.get("/api/area/recommendations?limit=3")
        assert response.status_code == HTTP_200_OK
    ...
    def test_filter_by_interests(self, client: TestClient) -> None:
        ...
        response = client.get("/api/area/recommendations?interests=golf,beach")
        assert response.status_code == HTTP_200_OK
    ...
    def test_filter_family_friendly_only(self, client: TestClient) -> None:
        ...
        response = client.get("/api/area/recommendations?family_friendly_only=true")
        assert response.status_code == HTTP_200_OK
    ...
    def test_combined_filters(self, client: TestClient) -> None:
        ...
        response = client.get(
            "/api/area/recommendations?interests=golf&max_distance_km=20&family_friendly_only=true&limit=2"
        )
        assert response.status_code == HTTP_200_OK
    ...
    def test_no_interests_returns_diverse_recommendations(self, client: TestClient) -> None:
        ...
        response = client.get("/api/area/recommendations?limit=10")
        assert response.status_code == HTTP_200_OK
    ...
    def test_limit_max_is_20(self, client: TestClient) -> None:
        ...
        response = client.get("/api/area/recommendations?limit=25")
    ...
    def test_limit_min_is_1(self, client: TestClient) -> None:
        ...
        response = client.get("/api/area/recommendations?limit=0")
